...
Lastly, let me reiterate the quote from [[https://en.wikipedia.org/wiki/Richard_Hamming][R.W. Hamming]] in the syllabus:
...
There is very little in this course which can simply be memorized. What we
first aspire to is an understanding of the output we are producing and how it
will be used. Only then can we discuss methods to calculate the output, and
its required inputs.  Note I mentioned the output first---you need to know
what you want before you think about how to get it.
